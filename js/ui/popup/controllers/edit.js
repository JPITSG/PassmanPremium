...
(function () {
    ...
    angular.module('passmanExtension')
        .controller('EditCtrl', ['$scope', '$routeParams', '$timeout', '$rootScope', function ($scope, $routeParams, $timeout, $rootScope) {
            ...
            $scope.saveCredential = function () {
                ...
                if ($scope.credential.password !== $scope.credential.password_repeat) {
                    $scope.formError = API.i18n.getMessage('no_password_match');
                    return;
                }
                ...
                API.runtime.sendMessage(API.runtime.id, {
                    ...
                    if (!$scope.credential.credential_id) {
                        $rootScope.$broadcast('status', API.i18n.getMessage('credential_created'));
                    } else {
