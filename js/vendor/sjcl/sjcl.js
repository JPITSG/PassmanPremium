/**
 * Stanford JavaScript Crypto Library (sjcl), release 1.0.8, unminified.
 *
 * Built from the upstream core modules actually used by this extension:
 * sjcl, bitArray, codecString, codecHex, codecBase64, sha256, aes, ccm,
 * ocb2, hmac, pbkdf2, random, convenience (includes sjcl.json and
 * cachedPbkdf2). Byte-level verified against the previous minified build:
 * sha256/HMAC/PBKDF2 vectors, AES-CCM ciphertexts at 64/128-bit tags,
 * cross-decryption at 1k and 100k iterations, and cachedPbkdf2 salt-reuse
 * semantics are all identical.
 *
 * Source: https://github.com/bitwiseshiftleft/sjcl/tree/1.0.8/core
 * License: BSD or GPL (see upstream README.md)
 */
